...
<section class="ptb-100">
    <div class="container">
        <div class="row">
            ...
            <?php
            $adet_cek = $uye->veri_al("urunler where durum=1 and indirim=1");
            $topl = count($adet_cek);
            ...
            $sayfalama->url='/indirimli-kitaplar/sayfa/%d'; // %d degeri sayfa numarasını alır sayısal degeri alir. orası sabittir.
            ...
            $veri = $uye->veri_al("urunler where durum=1 and indirim=1 limit $sayfalama->baslangic,$sayfalama->sayfa_basina");
