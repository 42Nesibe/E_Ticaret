...
<section class="ptb-100">
    <div class="container">
        <div class="row">
            ...
            <?php
            $adet_cek = $uye->veri_al("urunler order by urunler_iD desc limit 12");
            $topl = count($adet_cek);
            $sayfalama= new Sayfalama_galeri();
            $sayfalama->sayfa=& $uye->komut_istek(2);
            $sayfalama->sayfa_basina=6; // kac satır gosterilecek. icinde kac tane ürün gösterilecegi
            $sayfalama->url='/son-eklenenler/sayfa/%d'; // %d degeri sayfa numarasını alır sayısal degeri alir. orası sabittir.
            ...
            $veri = $uye->veri_al("urunler order by urunler_iD desc limit $sayfalama->baslangic,$sayfalama->sayfa_basina");
